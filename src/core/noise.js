...
// a seedable permutation table so each scene can have its own coherent field.
// Simplex (rather than classic Perlin) gives smoother gradients and no
// directional artifacts, which matters a lot for the flow-field sketch.
...
export class Noise {
  ...
  /** Fractal Brownian motion: sum several octaves for richer detail. */
